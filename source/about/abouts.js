...
function bot_ui_ini() {
    ...
    var sure = function () {
            ...
            botui.message.add({
                delay: 800,
                content: "![...](https://cdn.jsdelivr.net/gh/XXXZhy/Blog_Image/images/黄狗白眼.webp)"
            })
        },
        secondpart = function () {
            botui.message.add({
                ...
                .then(function () {
                    botui.message.add({
                            delay: 1500,
                            content: "是学计算机科学与技术专业的小萌新😬"
                        })
                        .then(function () {
                            botui.message.add({
                                    delay: 1200,
                                    content: "喜欢瞎捣鼓，会因为学到一点儿小技巧高兴"
                                })
                                .then(function () {
                                    botui.message.add({
                                            delay: 1500,
                                            content: "主修 Javascript 和 c语言,略知 linux,偶尔也搞 Java"
                                        })
                                        .then(function () {
                                            botui.action.button({
                                                    delay: 1100,
        ...
        thirdpart = function () {
            botui.message.add({
                    delay: 1e3,
                    content: "因为喜欢XXXTentaction的歌"
                })
                .then(function () {
                    botui.message.add({
                            delay: 1500,
                            content: "Zhy是自己的缩写，谐音是🐷🐵🐟"
                        })
                        .then(function () {
                            botui.action.button({
                                    delay: 1500,
        ...
        fourthpart = function () {
            botui.message.add({
                    delay: 1e3,
                    content: "闲暇之余主要看电影🎥、唱歌📼、学吉他🎸、轮滑"
                })
                .then(function () {
                    botui.message.add({
                            delay: 1100,
                            content: "当然也会大家都会玩的游戏🎮~"
                        })
                        .then(function () {
                            botui.action.button({
                                    delay: 1500,
        ...
        fifthpart = function () {
            botui.message.add({
                    delay: 1e3,
                    content: "👀哦哟，被要联系方式了😚，自恋了自恋了~"
                })
                .then(function () {
                    botui.message.add({
                            delay: 1600,
                            content: "当然可以加我la，不过要备注哟!"
                        })
                        .then(function () {
                            botui.message.add({
                                delay: 1500,
                                content: "也欢迎您留言，我会及时回复的。🍺🍺🍺"
                            })
                        })
                })
        }
